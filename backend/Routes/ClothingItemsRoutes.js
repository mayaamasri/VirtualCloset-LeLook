...
router.post('/', upload.single('image'), removeBackground, insertClothingItemValidator, createItemController);
...
router.put('/:id', upload.single('image'), removeBackground, updateClothingItemValidator, updateItemController);
